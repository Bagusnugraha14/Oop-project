              ...
              <div className="grid lg:grid-cols-2 gap-12 items-center mb-24">
                <div>
                  ...
                  <p className="text-gray-300 mb-6 leading-relaxed">
                    ...
                    "objek" untuk merepresentasikan data dan metode. Paradigma
                    ini membuat kode lebih terstruktur, mudah dipelihara, dan
                  ...
                  <div className="space-y-4">
                    ...
                    >
                      ...
                      <div>
                        ...
                        <p className="text-gray-300 text-sm">
                          Mewariskan sifat dari className induk ke className
                          anak
                        </p>
                      </div>
                    </div>
                    ...
                    >
                      ...
                      <div>
                        ...
                        <p className="text-gray-300 text-sm">
                          Menyembunyikan detail kompleks, menampilkan yang
                          penting
                        </p>
                      </div>
                    </div>
